  ...
  return (
    <>
      <DeleteConfirmation
        ...
        body="Are you want delete this article?"
        confirmDeleteHandler={confirmDeleteHandler}
      ></DeleteConfirmation>
      <Row className="mt-2">
        <Col md={{ span: 4, offset: 4 }}>
          <Button className="button-add" variant="primary" onClick={() => navigate("/add-fruit")}>
            Add New Article
          </Button>
        </Col>
      </Row>
          ...
          <Col key={item.id}>
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text>Quantity(Units): {item.quantity}</Card.Text>
